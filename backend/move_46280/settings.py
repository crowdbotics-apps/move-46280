"""
Django settings for move_46280 project.
...
WSGI_APPLICATION = 'move_46280.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "move_46280 API",
    "DESCRIPTION": "API documentation for move_46280 App",
    "VERSION": "v1",
}
